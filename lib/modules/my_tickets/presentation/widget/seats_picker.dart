...
class SeatPicker extends ConsumerStatefulWidget{
  ...
  SeatPicker(this.refresh, {super.key, required this.listOfSeats, required this.ticket});
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: SizedBox(
            width: 300,
            child: CustomButton(child: Text("confirm".tr()), onPressed: ()async{
              await ref.read(myTicketsProvider.notifier).changeWaitList(ticketId: widget.ticket, seatLocation: selectedSeat!);
