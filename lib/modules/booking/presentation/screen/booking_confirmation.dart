...
class BookingConfirmation extends ConsumerStatefulWidget {
  ...
  const BookingConfirmation(
      {super.key, required this.listOfSeats, required this.flight});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: CustomText("bookingConfirmation".tr()),
      ),
      body: Center(
        child: Card(
          child: SizedBox(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: CustomText(
                        getFormatedDate(widget.flight.date, false).toString(),
                        fontsize: 20,
                      ),
                    ),
                    const Spacer(),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: CustomText(
                        getFormatedDate(widget.flight.date, true).toString(),
                        fontsize: 20,
                      ),
                    )
                  ],
                ...
                Row(
                  children: [
                    ...
                    if (ref.read(bookingStateProvider.notifier).selectedType ==
                        "Economy")
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: CustomText(
                          widget.flight.economy_price.toString(),
                          fontsize: 20,
                        ),
                      ),
                    if (ref.read(bookingStateProvider.notifier).selectedType ==
                    ...
                    if (ref.read(bookingStateProvider.notifier).selectedType ==
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child:
                            CustomText(widget.flight.business_price.toString()),
                      ),
                    CustomText("sr".tr()),
                    const Spacer(),
                    Padding(
                      ...
                      child: TextButton(
                          onPressed: () async {
                            await ref
                                ...
                                .getPlane(planeId: widget.flight.planeId);
                              ...
                              onPressed: () async {
                                ...
                                await ref
                                    ...
                                    .sendTicket(
                                        ...
                                        context: context);
                                if (ref.read(bookingStateProvider)
                                    is BookingFailure) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          content: Text(
                                              "User Exceeded 10 tickets for this flight")));
                                  return;
                                } else {
